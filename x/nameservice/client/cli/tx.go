...
// GetCmdBuyName is the CLI command for sending a BuyName Tx
...
// GetCmdSetName is the CLI command for sending a SetName Tx
...
// GetCmdDeleteName is the CLI command form sending a DeleteName Tx
