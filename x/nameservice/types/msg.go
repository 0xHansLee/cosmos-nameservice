...
// NewMsgSetName - constructor of the MsgSetName
...
// ValidateBasic runs stateless checks on the message (check existence of owner, name, value)
...
// NewMsgBuyName - constructor of the MsgBuyName
...
// GetSignBytes encodes the msg for signing
